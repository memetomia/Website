...
<meta name="title" value="<?php echo $sMetaTitulo; ?>">
<meta property="title" content<?php echo $sMetaTitulo; ?>
 <meta name="og:title" value="<?php echo $sMetaTitulo; ?>">
<meta property="og:title" content="<?php echo $sMetaTitulo; ?>">
<meta name="twitter:title" value="<?php echo $sMetaTitulo; ?>">
<meta property="twitter:title" content="<?php echo $sMetaTitulo; ?>">
