...
//IAMGEN NORMAL
                    ...
                    if ($iTipoMedia == 4) {//gif
                        ...
                        $botonplay .= '<script type="text/javascript">'
                                . '$("#Video-' . $iID . '").click(function() {
                                                           $("#d-' . $iID . '").html(\'<img class="img-thumbnail img-small" src="' . EXT_ARTICLE . "/" . $sInfoMedia . '"/>\');
                                                       });                               </script>';
                    }
                    if ($iTipoMedia == 5) {
                        $sUrlaMostrar = '<img class="img-thumbnail img-small" src="' . EXT_ARTICLE . "/" . $sInfoMedia . '"/>';
