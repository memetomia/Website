...
//IAMGEN NORMAL
             ...
             //   VINE
                ...
                <div class="post-options col-md-3">
                    ...
                    <button id="FB-<?php echo $bd->bd->obtener_respuesta($i, "ID") ?>" d-link="http://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode("http://www.memetomia.com/Imagen.php?id=") . $bd->bd->obtener_respuesta($i, "ID") . "&t=" . $bd->bd->obtener_respuesta($i, "TITLE") ?>" type="button" class="btn btn-primary btn-block">Facebook</button>
                    ...
                    <button id="TW-<?php echo $bd->bd->obtener_respuesta($i, "ID") ?>" d-link="https://twitter.com/intent/tweet?button_hashtag=&text=<?php echo urlencode("http://www.memetomia.com/Imagen.php?id=") . $bd->bd->obtener_respuesta($i, "ID") ?>"type="button" class="btn btn-info btn-block">Twitter</button>
