    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('#UrlImagen').keydown(function() {
                    if (event.which == 13) {
                        sDirImagen = $("#UrlImagen").val();
                        $("#Imagen").attr("src", $("#UrlImagen").val());

                        $("#Img-thumbnail").attr("src", $("#UrlImagen").val());
                    }
                });
                ...
                <div class="col-sm-5 col-sm-offset-3 col-md-5 col-md-offset-2 main">
                    ...
                    <div class="row placeholders">
                        <form role="form">
                            ...
                            <div class="form-group">
                                <label for="UrlImagen">Url  de la imagen del vine </label>
                                <input type="text" class="form-control" id="UrlImagen" value="https://v.cdn.vine.co/r/thumbs/46B23C3BB91084627087769432064_2.0.3.1032442651813206051.mp4.jpg?versionId=Woob3BUJHmxQYcuOAXq22p82fybFDEeL">
                                <img id="Img-thumbnail" class="post-media img-thumbnail" width="200" heigth="200" src="../media/example_img/VideoPredeterminado.jpg" height="467" width="460" alt="I must become someone else, I must become something else">
                                <div id="MsgUrlYouTube" class="msgbox Oculto "></div>

                            </div>
                            <div class="form-group">
                                <label for="Urlvideo">Url del video vine</label>
                                <input type="text" class="form-control" id="Urlvideo" value="https://v.cdn.vine.co/r/videos/CBBAE5C3741084627082752978944_21f03ed0169.0.3.1032442651813206051.mp4?versionId=8nwHMw_cD_NlVMji4rD6rWVqf_3nCfKZ">
                                <div id="MsgUrlYouTube" class="msgbox Oculto "></div>
                                <video id="video-thumbnail" class="post-media img-thumbnail" controls src="" width="200" heigth="200" ></video>
                            </div>
