        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var uploader = new qq.FileUploader({
                    ...
                    action: '/OnionFW/web/controllers/subirImagenmeme.php',
            ...
            function Modificar(iPosicionEnPantalla, iIdEnTabla) {
                location.href = SERVER + ADMIN + "/EditarMeme.php?ID=" + iIdEnTabla;
            }
        </script>
    </head>
                                ...
                                if ($todo > 0) {
                                    ...
                                    for ($i = 0; $i < $todo; $i++) {
                                        ...
                                        $html .= '<tr id="t' . $i . '" class="' . $sClass . '"><td>' . $bd->bd->obtener_respuesta($i, "ID") . '</td>'
                                                ...
                                                . '<td><img class="img-thumbnail img-small" src="' . EXT_MEME . "/" . $bd->bd->obtener_respuesta($i, "URL") . '"/></td>'
