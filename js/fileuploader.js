...
qq.FileUploaderBasic.prototype = {
    ...
    _uploadFile: function(fileContainer){
        ...
        //            id:Obj.GetEscritorioActual(),
        //            iIdNumeroEscritorio:Obj.GetNumeroEscritorioActual()
        };
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        uploadButtonText: 'Cambiar fondo',
        cancelButtonText: 'Cancel',
        failUploadText: 'Upload failed',

        template: '<div class="qq-uploader">' +
        (!this._options.disableDefaultDropzone ? '<div class="qq-upload-drop-area" hidden ><span>{dragText}</span></div>' : '') +
        (!this._options.button ? '<div class="qq-upload-button"><span id="spanText">{uploadButtonText}<span></div>' : '') +
        (!this._options.listElement ? '<ul class="qq-upload-list" hidden></ul>' : '') +
        '</div>',
...
qq.extend(qq.FileUploader.prototype, {
        ...
        var dz = new qq.UploadDropZone({
            ...
            onDrop: function(e){
                ...
                for (var i = 0; i < e.dataTransfer.types.length; i++) {
                    ...
                    //   if (type=="text/plain"){
                    //
                    //                        $.post("c/jBuscarURL.php",{
                    //                            sUrl:e.dataTransfer.getData(type)
                    //                        },function(o){
                    //                            if (o.iValor==1) {
                    //                
                    //                             
                    //                                VentanaModal.Cerrar();
                    //                                VentanaCrearIcono.Abrir(o);
                    //                            }/*End if o.iValor==1 */
                    //                            else
                    //                            {
                    //                                Mensajes.Mostrar(o.sInfo);
                    //                               
                    //                            }/*End else o.iValor==1 */
                    //                        },"json");//End $.post("c/jBuscarURL.php",{sUrl:etqInputURL.val()},function(o){  
                    //                    }
    ...
    _setupDragDrop: function(){
        ...
        if (!this._options.disableDefaultDropzone && !qq.ie()) {
            this._attach(document, 'dragenter', function(e){
                //hector aqui pon la imagen o el texto q diga al usuario aqui usted puede soltar su 
                //imagen o su url 
              
    
      
                
                $("#Subir").css('background', "url(bcss/overbotonG.png)") ;           
                $("#spanText").html("Suelta aqui tu imagen");

            });
        }
       
        this._attach(document, 'dragleave', function(e){           
            $("#Subir").css('background', "url(bcss/botonG.png)") ;
            $("#spanText").html("Subir Imagen");
        });
     
     
        qq.attach(document, 'drop', function(e){
            $("#Subir").css('background', "url(bcss/botonG.png)") ;
            // $("#spanText").html("Subiendo");
    ...
    _onComplete: function(id, fileName, result){
        ...
        //       Obj.SetImagenEscritorio(result.iIdEscritorio,result.arc);
        //    Obj.PintarEscritorio();
        //            css = {
        //                'background':'url('+result.arc+"?"+Math.random()*11+')'
        //            }
        //    
        //            $('#Escritorio').css(css); 
        //    
        ...
        //            qq.addClass(item, this._classes.fail);
                 $("#spanText").html("Error Del Servidor");
                     window.setTimeout(function(){
        ...
        if (!qq.UploadDropZone.dropOutsideDisabled ){
            ...
            if (this._dragover_should_be_canceled){
                qq.attach(document, 'dragover', function(e){
                    //HECTOR aqui esta lo que pinta el escritorio con la imagen de fondo original
                    // cuando el ussuario deja de arrastrar un objeto dentro de la aplicacion
                    $("#Subir").css('background', "url(bcss/overbotonG.png)")
                    $("#spanText").html("Suelta aqui tu imagen");
                    e.preventDefault();
                });
