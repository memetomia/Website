...
<div class="modal fade" id="settings-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <form id="settings-profile-form" role="form">
                        <div class="form-group">
                            ...
                            <div class="well well-sm text-center">
                                <label for="settings-picture"><img src="" alt="user_pic" class="img-thumbnail" width="128" height="128"></label>
    ...
    <script type="text/javascript">
        ...
        modalSettings = function() {
            ...
            var $_checkboxVideo = $('#' + MODAL_PREFIX + 'videos');
            var $_checkboxGif = $('#' + MODAL_PREFIX + 'gif');
            ...
            function Iniciar() {
                ...
                $_oldPasswordField.val();
                $_newPasswordField.val();
                $_confirmPasswordField.val();

                /* PERFIL */

                $_userDescription.val();
                $_genderOptions.val();
                $_nameField.val();
            }
